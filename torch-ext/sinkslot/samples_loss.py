...
class _SLOTCostFn(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, X, Y, a, eps, L, seed, n_iters, backend):
    ...
    def backward(ctx, grad_output):
        ...
        return grad_output * grad_x, None, None, None, None, None, None, None
...
class SamplesLoss(torch.nn.Module):
    ...
    that's the formula backward reuses).
    """
