...
from .solver import _HAS_TRITON, sparse_sot_coo, _ot_1d_coo_batched_cuda, to_csr, sparse_sqeuclidean_cost
...
def hvp_x_sqeuclid(X, Y, a, eps, L, seed, n_iters, v, tau2=3e-7, solve_tol=1e-11,
    ...
    `sparse_sot_coo(X, Y, a, a, ...)` call (X, Y assumed equal-size, uniform-a,
